...
SPROMPT="%F{$ZSHGOD_THM_CATPPUCCIN_LAVENDER}zsh:%f %F{$ZSHGOD_THM_CATPPUCCIN_YELLOW}correct '%f%F{$ZSHGOD_THM_CATPPUCCIN_RED}%R%f%F{$ZSHGOD_THM_CATPPUCCIN_YELLOW}' to '%f%F{$ZSHGOD_THM_CATPPUCCIN_GREEN}%r%f%F{$ZSHGOD_THM_CATPPUCCIN_YELLOW}'? [%f%F{$ZSHGOD_THM_CATPPUCCIN_RED}n%f%F{$ZSHGOD_THM_CATPPUCCIN_GREEN}y%f%F{$ZSHGOD_THM_CATPPUCCIN_PEACH}a%f%F{$ZSHGOD_THM_CATPPUCCIN_BLUE}e%f%F{$ZSHGOD_THM_CATPPUCCIN_YELLOW}]:%f "
