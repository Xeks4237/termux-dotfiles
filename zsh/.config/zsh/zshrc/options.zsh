...
# [ Options related to Changing Directories ]
# AUTO_CD (-J)
...
#   Like if you cd in to some 4 directories and then use command 'cd -4'
#   it going to cd you in to your last 4th directory
setopt AUTO_PUSHD
...
#   chdir commands do not recognise arguments of the form '{+|-}_'
